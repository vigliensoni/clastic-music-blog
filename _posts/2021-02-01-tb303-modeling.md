...
I'll check if I can write a MIDI sequence, convert it to a numpy array, and pass it to the model to resynthesize it.


In `freq-sweep-by-hand-2-from-badu-retrain.wav` I'm creating a linear frequency sweep from 0 to 1000 Hz